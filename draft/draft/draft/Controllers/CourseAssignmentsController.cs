...
namespace draft.Controllers
{
    public class CourseAssignmentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CourseId,TeacherId,Id")] CourseAssignment courseAssignment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CourseId,TeacherId,Id")] CourseAssignment courseAssignment)
        {
